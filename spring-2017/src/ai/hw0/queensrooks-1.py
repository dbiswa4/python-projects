...
def successors2(board):
    print 'successors()2 - get list of successors...'
    print 'find list of successors for board : ', board
    successors_boards = []
    for c in range(0, N):
        for r in range(0, N):
...
#3 Get list of successors of given board state
'''
This is as good as successors() as add_piece() is not considering the board modified in previous state
successors() or add_piece() method needs to ensure that if the board passed is modified, it considers it while coming up with other board in successor list
'''
...
def successors5(board, total_pieces, eval_dia_danger_flag=0):
    print 'successors()5 - get list of successors...'
    print 'find list of successors for board : ', board
    successors_boards = []
        ...
        if count_on_col(board, c) == 0:
            for r in range(0, total_pieces):
                ...
                if eval_dia_danger_flag:
                    ...
                    print 'r : ', r
                    print 'c : ', c
                    print 'dia_danger_flag : ', dia_danger_flag
...
#print (printable_board(solution, 'R',0) if solution else "Sorry, no solution found. :(")
